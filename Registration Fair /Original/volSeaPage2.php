...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Volunteer Search By ID Table</title>
            ...
            <div class="u-align-center u-container-style u-grey-5 u-layout-cell u-size-30 u-layout-cell-2">
              <div class="u-container-layout u-valign-middle u-container-layout-2">
					<?php
						...
						echo"<br/><br/>";
						//Query the table
						$result = mysqli_query($conn,"SELECT*From volunteers where id = '$id'");
               ...
               echo "<td>" . $row['id'] . "</td>";
                 ...
                 echo " <tr>";
                    ...
                    echo "<td>" . $row['telephone'] . "</td>";
                     ...
                     echo " </tr>";
                 echo " <tr>";
                    echo"<th>Volunteer Option</th>";
                    echo "<td>" . $row['volunteerOption'] . "</td>";
                     echo " </tr>";
                 echo " <tr>";
                    echo"<th>confirmedField</th>";
