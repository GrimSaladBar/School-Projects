...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Volunteer List By Option Page</title>
          ...
          <div class="u-layout-row">
            ...
            <div class="u-align-center u-container-style u-grey-5 u-layout-cell u-size-30 u-layout-cell-2">
              <div class="u-container-layout u-valign-middle u-container-layout-2">
					<form action="volListOpt2.php" method="POST">
					 <label>
					Volunteer Options:
          
					<select name="volunteerOption" >
						 <option value="">Select your option</option>
						<option value="TicketSeller">Sell Tickets for Rides</option>
						<option value="Supervisor">Supervise the Rides</option>
						<option value="Caterer">Catering</option>
						<option value="Security">Security</option>
						<option value="Temperature Taker">Take Temperatures</option>
					</select>
					 </label>
