...
<link rel="stylesheet" href="Home.css" media="screen">
  ...
  <body data-home-page="template.html" data-home-page-title="Template" class="u-body"><header class="u-clearfix u-header u-header" id="sec-1b2e"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="index.html" style="padding: 10px 20px;">Registration Form</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="signin.php" style="padding: 10px 20px;">Admin Sign-in</a>
</li></ul>
          </div>
          <div class="u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Home.html">Link1</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="About.html">Link2</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Contact.html">Link3</a>
</li></ul>
              </div>
            </div>
	...
	echo "<table border='1'>
						   ...
						   echo "<td>" . $row['telephone'] . "</td>";
						    echo "<td>" . $row['volunteerOption'] . "</td>";
							 echo "<td>" . $row['confirmedField'] . "</td>";
                                   echo "</tr></table>";
							$result = mysqli_query($conn, "SELECT  COUNT(*) as count FROM volunteers where confirmedField = 'yes'");
		...
		echo "Currently they are ";echo "<div style=\"color: red;\">($var)</div>";	
		echo" confirmed volunteer.";
		 }
		else {	echo "Currently they are " .$var. " confirmed volunteer.";}	 	   
                    }
		} 
		else
		{
	...
	<br>
		<!-- Footer Stuff goes here -->
			...
			<Map name="HomeLogo">
				<area shape = "rect" coords="0,0,344,111" href="index.html"/>
			</map>
