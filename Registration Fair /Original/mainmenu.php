...
<link rel="stylesheet" href="mainmenu.css" media="screen">
  ...
  <body data-home-page="template.html" data-home-page-title="Template" class="u-body"><header class="u-clearfix u-header u-header" id="sec-1b2e"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="mainmenu.php" style="padding: 10px 20px;"><span style="color:black">Main Menu</span></a>
</li><li class="u-nav-item"></li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="logout.php" style="padding: 10px 20px;">Log Out</a>
</li></ul>
          </div>
    ...
    <section class="u-clearfix u-section-1" id="carousel_0d8a">
      <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
	   ...
	   <td><button><a href="volListPage.php" ><span style="color:black">Volunteer List</a></td>

	    <td><button><a href="volListOpt.php" ><span style="color:black">Volunteer List By Option</a></td>
		</tr>
		<tr>
		<td><button><a href="volSeaPage.php" ><span style="color:black">Volunteer Search</a></td>
	    <td><button><a href="confirmVol.php"><span style="color:black">Confirm Volunteer</a></td>
		</tr>
		<tr>
		<td><button><a href="delVol.php" ><span style="color:black">Delete Volunteer</a></td>
	    <td><button><a href="about.php" ><span style="color:black">About</span></a></button></td>
		</tr>
		</table>
