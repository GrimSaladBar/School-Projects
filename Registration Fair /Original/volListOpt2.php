...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Volunteer List By Option Table</title>
  ...
  <body data-home-page="template.html" data-home-page-title="Template" class="u-body"><header class="u-clearfix u-header u-header" id="sec-1b2e"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="index.html" style="padding: 10px 20px;"></a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="logout.hph" style="padding: 10px 20px;">Log Out</a>
</li></ul>
          </div>
          ...
          <div class="u-layout-row">
            ...
            <div class="u-align-center u-container-style u-grey-5 u-layout-cell u-size-30 u-layout-cell-2">
              <div class="u-container-layout u-valign-middle u-container-layout-2">
					<?php
			  $volunteerOpt=$_POST["volunteerOption"];
			  ...
			  if(!$conn)
				...
				echo"<br/><br/>";
				//Query the table
				$result = mysqli_query($conn,"SELECT*From volunteers where volunteerOption = '$volunteerOpt'");
